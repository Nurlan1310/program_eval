...
urlpatterns = [
    ...
    path('program/<int:pk>/ai-analytics/', views.program_ai_analytics, name='program_ai_analytics'),
    path('program/<int:pk>/ai-analytics/pdf/', views.download_program_ai_pdf, name='download_program_ai_pdf'),
